...
class PksTransAt:
    ...
    def __init__(self, ks_domain: Domain, carriers: list[Domain], modification_domains: list[Domain], validate: bool = True, **kwargs) -> None:
...
class PksIterative(PksModular):
    ...
    def __init__(self, at_domain: Domain, ks_domain: Domain, carriers: list[Domain], modification_domains: list[Domain], iterations: int, validate: bool = True, **kwargs) -> None:
        self.iterations = iterations
        super().__init__(at_domain, ks_domain, carriers, modification_domains, validate, **kwargs)
